...
Architecture Role:
    ...
    It implements the Gymnasium Env interface that the Q-Learning agent expects,
...
class TrafficEnv(gym.Env):
    ...
    The Q-Learning agent controls the traffic light to minimize congestion.
    ...
    def __init__(
        ...
        # Q-Learning with Discrete action space uses Q-values.
